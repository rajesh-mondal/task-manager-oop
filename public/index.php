...
$task1 = new TaggedDeadlineTask( 'Task 1', 'Should be done within Thursday', '04-10-2023', '10-10-2023' );
$task1->addTag( 'Frontend' );
$task1->addTag( 'Contact Page' );
$task1->addAssignee( 'Rajesh' );
$task1->addAssignee( 'Raju' );

$task2 = new DeadlineTask( 'Task 2', 'Should be done within Sunday', '08-10-2023', '15-10-2023' );
$task2->addAssignee( "Raj" );
